...
bhmie = Extension(
    name='disklab.opacity.bhmie_fortran',
    sources=['disklab/opacity/bhmie_fortran.f90'])

distri = Extension(
    name='disklab.opacity.fit_module',
    sources=['disklab/opacity/fit_module.f90'])

extensions = [diffusion, bhmie, distri]
