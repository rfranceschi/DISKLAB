...
def radmc3d(command, executable='radmc3d'):
    """
...
def write_grid(ri, thetai, phii, mirror=True):
    """
...
def write_dust_density(rho2, mirror=True):
    """
...
def write_density3d(rho3, fname='dust_density.inp'):
    """
...
def write_opacity(disk2d):
    ...
    write_opacity_info(species=[str(id) for id in id_species])
...
def get_radmc3d_arrays(disk2d, nr_add=10, dr_add=0.05, showplots=False):
    """
